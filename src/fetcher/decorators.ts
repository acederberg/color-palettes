...
const FORMAT_PROPERTY_VALIDATION_ERROR_MSG = ( property_name : string, property_value : string, msg : string ) => `Validation error for ${ property_name }=${ property_value }: ${ msg }`
